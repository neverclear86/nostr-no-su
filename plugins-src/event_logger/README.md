...
```sh
curl -s -u admin:<ADMIN_PASSWORD> http://127.0.0.1:24133/plugins/event_logger/settings
curl -s -u admin:<ADMIN_PASSWORD> http://127.0.0.1:24133/plugins/event_logger/timeline
curl -s -u admin:<ADMIN_PASSWORD> -H 'Accept-Language: ja' http://127.0.0.1:24133/plugins/event_logger/settings
```
