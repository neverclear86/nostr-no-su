...
pub fn messages_with_values_follow_each_language_test() {
  let cases = [
    ...
    #(
      ...
      "Up to 100 characters (an emoji can count as several).",
      "100 文字まで（絵文字は数文字分になることがあります）。",
    ),
...
fn next_message(message: i18n.Message) -> Option(i18n.Message) {
  case message {
    ...
    i18n.Revoke -> Some(i18n.RevokeSessionDescription)
    i18n.RevokeSessionDescription -> Some(i18n.Relays)
    ...
    i18n.ReenablePlugin -> Some(i18n.NoResponse)
    i18n.NoResponse -> Some(i18n.Dropped(3))
    ...
    i18n.PluginImageNotShown -> Some(i18n.OpenPluginPage)
